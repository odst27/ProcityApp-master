...
public class FetchDonatedItems extends AsyncTask<String, String, String> {

	private Activity thisAct;
	
	public FetchDonatedItems(Activity act){		
		super();
		thisAct = act;
	}
	...
	public String doInBackground(String... arg0) {
		...
		ActionEngine.json = ActionEngine.jsonParser.makeHttpRequest(ActionEngine.fetchdonateditems,
				"POST", params);
