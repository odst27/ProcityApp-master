...
public class FetchClaimedItems extends AsyncTask<String, String, String> {

	private Activity thisAct;
	
	public FetchClaimedItems(Activity act){		
		super();
		thisAct = act;
	}
	...
	public String doInBackground(String... arg0) {
		...
		ActionEngine.json = ActionEngine.jsonParser.makeHttpRequest(ActionEngine.fetchclaimeditems,
				"POST", params);
